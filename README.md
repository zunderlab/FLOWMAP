...
**For single/one:**
1. Select the order of the FCS files that you wish to use. If there is only 1 FCS file, choose the number of the file that is shown.
